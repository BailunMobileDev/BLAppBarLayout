...
public abstract class HeaderBehavior<V extends View> extends ViewOffsetBehavior<V> {
  ...
  protected int reboundLength = 500;
  ...
  public int getReboundLength() {
    return reboundLength;
  }

  public void setReboundLength(int reboundLength) {
    this.reboundLength = reboundLength;
  }
  ...
  public boolean onTouchEvent(
    ...
    switch (ev.getActionMasked()) {
      case MotionEvent.ACTION_MOVE:
        ...
        scroll(parent, child, dy, getMaxDragOffset(child), reboundLength);
        break;
      ...
      case MotionEvent.ACTION_UP:
        if (velocityTracker != null) {
          ...
          fling(parent, child, -getScrollRangeForDragFling(child), reboundLength, yvel);
        }
